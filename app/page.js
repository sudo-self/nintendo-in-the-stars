...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-800 via-purple-700 to-pink-700 md:from-indigo-900 md:via-purple-900 md:to-pink-800 p-4 md:p-8 text-white overflow-hidden relative">
        ...
        {stars.map((star, i) => (
          <div
            ...
            style={{
              ...
              top: `${star.top}%`,
              left: `${star.left}%`,
              opacity: Math.max(star.opacity, 0.5), // mobile-friendly min opacity
      ...
      <div className="relative text-center mb-8 z-10">
        <h1 className="text-4xl md:text-6xl font-bold mb-2 relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300 drop-shadow-lg glow-purple">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Game display */}
        {selectedRom && (
          <div className="bg-gray-800/70 backdrop-blur-md rounded-xl p-6 border border-gray-700 shadow-2xl mb-8 transform transition-all duration-300 hover:shadow-purple-500/20">
        ...
        {/* Game library */}
        {roms.length > 0 && (
          <div className="bg-gray-800/70 backdrop-blur-md rounded-xl p-6 border border-gray-700 shadow-2xl mt-8">
